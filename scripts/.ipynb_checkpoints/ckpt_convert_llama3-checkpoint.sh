...
CHECKPOINT_SAVE_DIR=/groups/gcb50243/ma/ckpts/llama-3.1-8B-megatron_tp${TENSOR_PARALLEL_SIZE}_pp${PIPELINE_PARALLEL_SIZE}_LR1e-4/
#CHECKPOINT_SAVE_DIR=/groups/gcb50243/ma/ckpts/llama-3.1-8B-megatron_tp${TENSOR_PARALLEL_SIZE}_pp${PIPELINE_PARALLEL_SIZE}
PATH_TO_TORCH_CKPT=/groups/gcb50243/ma/ckpts/llama-3.1-8B-megatron_tp${TENSOR_PARALLEL_SIZE}_pp${PIPELINE_PARALLEL_SIZE}_LR1e-4_torch

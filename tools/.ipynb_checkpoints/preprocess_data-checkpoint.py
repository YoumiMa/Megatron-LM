...
class Partition(object):
    ...
    def print_processing_stats(self, count, proc_start, total_bytes_processed, total_tokens_processed):
        if count % self.args.log_interval == 0:
            ...
            tokens_in_billion = total_tokens_processed/1000/1000/1000
            mbs = total_bytes_processed/elapsed/1024/1024
            print(f"Processed {count} documents, {tokens_in_billion} B tokens,",
    ...
    def process_json_file(self, file_name):
        ...
        for i, (doc, sentence_lens, bytes_processed) in tqdm(enumerate(encoded_docs, start=1)):
            total_bytes_processed += bytes_processed            
            for key in doc.keys():
